                ...
                <div class="card-body" style="width: 70%">
                    ...
                    <div class="card-price d-flex mt-1" style="justify-content: space-between;height:10%;align-items:center;">
                      ...
                      <button class="border-0 fs-4 bg-transparent mb-3">
                        <i class="fa-solid fa-cart-shopping data-cateName="${product.cateName}" data-id="${product.id}" data-favorite="${product.IsFavorite}" onclick="toggleFavorite(event)"  style="color: red""></i>
